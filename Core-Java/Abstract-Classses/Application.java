...
//In this example, we consider three entities; Loki, Thor and Odin. Odin is the parent and Thor and Loki are his children respectively.

public class Application {
	public static void main(String[] args) {
		
		// Odin Odin1 = new Odin(); // When the Parent class is abstract, it can't be instantiated.
		// the Odin type can't be instantiated(i.e., an object cannot be created).
