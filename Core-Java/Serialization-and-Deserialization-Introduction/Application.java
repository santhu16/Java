//Serialization is a process of translating objects into a binary format so that it can be stored for future purposes.

import java.io.Serializable;

public class Application implements Serializable { // Application class implements Serializable
